...
- **Not taken from pesa1234 `next-r4.9.2.rss.mtk`** — 32 of his fork-local
  ...
  - **ksmbd TCP keepalive** (`833a3e55ff`, `8c89b550ce`, `503-01`/`503-02`):
    ksmbd is not used on these devices.
  ...
  - **His `9999-07` `init_vif` unwind hunk**: upstream mt76 added the same
    unwind between his pin `59676919` and ours `b2704cf5`; we inherit it via
  ...
  - **`9999-17` fix-stranded-frames-in-tx-scheduler** (`bec97cd705`): already
    ...
    `b2704cf5` (2026-08-01) already carries; applying it is a no-op
  ...
  - **ksmbd signing / session teardown** (`ba77feec2a`, `4b3d91053a`,
    ...
    `502-v7.3-...`, which this fork already carries.
